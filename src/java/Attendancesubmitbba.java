 ...
 * @author Dell
 */
@WebServlet(urlPatterns = {"/Attendancesubmitbba"})
public class Attendancesubmitbba extends HttpServlet {
             ...
             conn = (Connection) DriverManager.getConnection("jdbc:mysql://localhost/collegemanagementsystem", "root", "");
{
                 ...
                 String insertQuery = "INSERT INTO bba_students_attendance (b_student_id, attendance_date, status,name_of_student) VALUES (?, ?, ?,?)";
